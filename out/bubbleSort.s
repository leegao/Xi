...
_IbubbleSort_aiai:
	...
	movq %rbx, -56(%rbp)		# movq %r(1034), -56(%rbp)
	movq $0, %r13		# movq $0, %r(985)
	movq %r13, %rbx		# movq %r(985), %r(1035)
	movq %rbx, -64(%rbp)		# movq %r(1035), -64(%rbp)
	jmp .L99		# jmp .L99
	.L99:		# .L99:
	movq $8, %rbx		# movq $8, %r(986)
	movq -56(%rbp), %r14		# movq -56(%rbp), %r(1036)
	...
	movq -56(%rbp), %r14		# movq -56(%rbp), %r(1052)
	...
	jmp .L114		# jmp .L114
	.L114:		# .L114:
	movq -64(%rbp), %rbx		# movq -64(%rbp), %r(1092)
	incq %rbx		# incq %r(1092)
	movq %rbx, -64(%rbp)		# movq %r(1092), -64(%rbp)
	jmp .L99		# jmp .L99
	.L101:		# .L101:
	movq -56(%rbp), %rbx		# movq -56(%rbp), %r(1093)
...
_Imain_paai:
	...
	movq %rbx, -24(%rbp)		# movq %r(1171), -24(%rbp)
	...
	movq %rbx, -24(%rbp)		# movq %r(1172), -24(%rbp)
	jmp .L130		# jmp .L130
	.L130:		# .L130:
	movq -24(%rbp), %rbx		# movq -24(%rbp), %r(1173)
	movq %rbx, %rdi		# movq %r(1173), %rdi
	call _Iassert_pb		# call _Iassert_pb
	movq $1, %r13		# movq $1, %r(1137)
	movq %r13, %rbx		# movq %r(1137), %r(1174)
	movq %rbx, -16(%rbp)		# movq %r(1174), -16(%rbp)
	...
	movq %rbx, -16(%rbp)		# movq %r(1175), -16(%rbp)
	jmp .L134		# jmp .L134
	.L134:		# .L134:
	movq -16(%rbp), %rbx		# movq -16(%rbp), %r(1176)
	...
	movq %rbx, -32(%rbp)		# movq %r(1178), -32(%rbp)
	jmp .L138		# jmp .L138
	.L138:		# .L138:
	movq -32(%rbp), %rbx		# movq -32(%rbp), %r(1179)
