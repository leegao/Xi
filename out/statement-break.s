...
_Imain_paai:
	...
	call _I_c_internal_strdup_aii		# call _I_c_internal_strdup_aii
	movq %rax, %r12		# movq %rax, %r(3639)
	movq $1, %rbx		# movq $1, %r(3660)
	movq %rbx, %r14		# movq %r(3660), %r(3630)
	movq $10, %rbx		# movq $10, %r(3661)
	cmpq %rbx, %r15		# cmpq %r(3661), %r(3626)
	je .L648		# je .L648
	.L649:		# .L649:
	movq $0, %rbx		# movq $0, %r(3662)
	movq %rbx, %r14		# movq %r(3662), %r(3630)
	jmp .L648		# jmp .L648
	.L648:		# .L648:
	movq %r12, %rdi		# movq %r(3639), %rdi
	movq %r14, %rsi		# movq %r(3630), %rsi
	call _Itest_paib		# call _Itest_paib
	jmp .L627		# jmp .L627
	.L627:		# .L627:
	popq %r15
...
_I_c_internal_strdup_aii:
	...
	movq %r12, -8(%rbp)		# movq %r(3677), -8(%rbp)
	movq -8(%rbp), %r12		# movq -8(%rbp), %r(3678)
