...
_Imain_paai:
	...
	movq %rax, %r14		# movq %rax, %r(114)
	movq $3, %r12		# movq $3, %r(125)
	movq %r12, (%r14)		# movq %r(125), (%r(114))
	movq $8, %r12		# movq $8, %r(126)
	addq %r12, %r14		# addq %r(126), %r(127)
	movq $0, %r12		# movq $0, %r(128)
	movq %r14, %rbx		# movq %r(100), %r(129)
	addq %r12, %rbx		# addq %r(128), %r(129)
	movq $65, %r12		# movq $65, %r(130)
	movq %r12, (%rbx)		# movq %r(130), (%r(129))
	movq $8, %r12		# movq $8, %r(131)
	movq %r14, %rbx		# movq %r(100), %r(132)
	addq %r12, %rbx		# addq %r(131), %r(132)
	movq $66, %r12		# movq $66, %r(133)
	movq %r12, (%rbx)		# movq %r(133), (%r(132))
	movq $16, %r12		# movq $16, %r(134)
	movq %r14, %rbx		# movq %r(100), %r(135)
	addq %r12, %rbx		# addq %r(134), %r(135)
	movq $67, %r12		# movq $67, %r(136)
	movq %r12, (%rbx)		# movq %r(136), (%r(135))
	leaq .L46(%rip), %rdi		# leaq .L46(%rip), %rdi
	call _I_c_internal_strdup_aii		# call _I_c_internal_strdup_aii
	movq %rax, %r12		# movq %rax, %r(115)
	movq %r12, %rdi		# movq %r(115), %rdi
	movq %r14, %rsi		# movq %r(100), %rsi
	...
	movq $3, %rbx		# movq $3, %r(152)
	movq %rbx, (%r13)		# movq %r(152), (%r(119))
	movq $8, %rbx		# movq $8, %r(153)
	addq %rbx, %r13		# addq %r(153), %r(154)
	movq %r13, %r15		# movq %r(154), %r(105)
	movq $0, %rbx		# movq $0, %r(155)
	movq %r15, %r13		# movq %r(105), %r(156)
	addq %rbx, %r13		# addq %r(155), %r(156)
	movq $73, %rbx		# movq $73, %r(157)
	movq %rbx, (%r13)		# movq %r(157), (%r(156))
	movq $8, %rbx		# movq $8, %r(158)
	movq %r15, %r13		# movq %r(105), %r(159)
	addq %rbx, %r13		# addq %r(158), %r(159)
	movq $74, %rbx		# movq $74, %r(160)
	movq %rbx, (%r13)		# movq %r(160), (%r(159))
	movq $16, %rbx		# movq $16, %r(161)
	movq %r15, %r12		# movq %r(105), %r(162)
	addq %rbx, %r12		# addq %r(161), %r(162)
	movq $75, %rbx		# movq $75, %r(163)
	movq %rbx, (%r12)		# movq %r(163), (%r(162))
	movq %r14, %rdi		# movq %r(118), %rdi
	movq %r15, %rsi		# movq %r(105), %rsi
	call _I_c_internal_strcat_aiaiai		# call _I_c_internal_strcat_aiaiai
...
_I_c_internal_strdup_aii:
	...
	call _I_alloc_i		# call _I_alloc_i
	movq %rax, %r14		# movq %rax, %r(122)
	jmp .L24		# jmp .L24
	.L24:		# .L24:
	movq -16(%rbp), %r12		# movq -16(%rbp), %r(180)
	salq $3, %r12		# salq $3, %r(168)
	movq %r14, %r13		# movq %r(122), %r(169)
...
_I_c_internal_strcat_aiaiai:
	...
	movq %rbx, -64(%rbp)		# movq %r(211), -64(%rbp)
	movq %rsi, %rbx		# movq %rsi, %r(212)
	movq %rbx, -56(%rbp)		# movq %r(212), -56(%rbp)
	movq $0, %r12		# movq $0, %r(188)
	movq %r12, -24(%rbp)		# movq %r(213), -24(%rbp)
	movq $8, %rbx		# movq $8, %r(189)
	movq -64(%rbp), %r13		# movq -64(%rbp), %r(214)
	...
	movq -48(%rbp), %r12		# movq -48(%rbp), %r(217)
	addq %rbx, %r12		# addq %r(194), %r(195)
	movq %r12, -40(%rbp)		# movq %r(218), -40(%rbp)
	movq $1, %rbx		# movq $1, %r(196)
	movq -40(%rbp), %r13		# movq -40(%rbp), %r(219)
	addq %rbx, %r13		# addq %r(196), %r(197)
	movq %r13, %rdi		# movq %r(197), %rdi
	call _I_alloc_i		# call _I_alloc_i
	movq %rax, %rbx		# movq %rax, %r(123)
	movq -40(%rbp), %r12		# movq -40(%rbp), %r(220)
	movq %r12, (%rbx)		# movq %r(220), (%r(123))
	movq $8, %r12		# movq $8, %r(198)
	addq %r12, %rbx		# addq %r(198), %r(199)
	movq %rbx, -8(%rbp)		# movq %r(221), -8(%rbp)
	jmp .L47		# jmp .L47
	.L47:		# .L47:
	movq -24(%rbp), %rbx		# movq -24(%rbp), %r(222)
	movq -48(%rbp), %r12		# movq -48(%rbp), %r(223)
	cmpq %r12, %rbx		# cmpq %r(223), %r(222)
	jge .L49		# jge .L49
	.L48:		# .L48:
	movq -24(%rbp), %r13		# movq -24(%rbp), %r(224)
	salq $3, %r13		# salq $3, %r(200)
	movq -8(%rbp), %rbx		# movq -8(%rbp), %r(225)
	...
	movq -24(%rbp), %r13		# movq -24(%rbp), %r(228)
	salq $3, %r13		# salq $3, %r(202)
	movq -64(%rbp), %rbx		# movq -64(%rbp), %r(229)
	movq %rbx, -16(%rbp)		# movq %r(230), -16(%rbp)
	movq -16(%rbp), %r12		# movq -16(%rbp), %r(231)
	addq %r13, %r12		# addq %r(202), %r(231)
	movq %r12, -16(%rbp)		# movq %r(231), -16(%rbp)
	movq -16(%rbp), %rbx		# movq -16(%rbp), %r(232)
	movq (%rbx), %rbx		# movq (%r(232)), %r(204)
	movq -32(%rbp), %r12		# movq -32(%rbp), %r(233)
	movq %rbx, (%r12)		# movq %r(204), (%r(233))
	movq -24(%rbp), %rbx		# movq -24(%rbp), %r(234)
	incq %rbx		# incq %r(234)
	movq %rbx, -24(%rbp)		# movq %r(234), -24(%rbp)
	jmp .L47		# jmp .L47
	.L49:		# .L49:
	jmp .L50		# jmp .L50
	.L50:		# .L50:
	movq -24(%rbp), %rbx		# movq -24(%rbp), %r(235)
	movq -40(%rbp), %r12		# movq -40(%rbp), %r(236)
	cmpq %r12, %rbx		# cmpq %r(236), %r(235)
	jge .L52		# jge .L52
	.L51:		# .L51:
	movq -24(%rbp), %r13		# movq -24(%rbp), %r(237)
	salq $3, %r13		# salq $3, %r(205)
	movq -8(%rbp), %r14		# movq -8(%rbp), %r(238)
	addq %r13, %r14		# addq %r(205), %r(206)
	movq -24(%rbp), %r15		# movq -24(%rbp), %r(239)
	movq -48(%rbp), %r13		# movq -48(%rbp), %r(240)
	subq %r13, %r15		# subq %r(240), %r(207)
	salq $3, %r15		# salq $3, %r(208)
	movq -56(%rbp), %rbx		# movq -56(%rbp), %r(241)
	movq %rbx, -72(%rbp)		# movq %r(242), -72(%rbp)
	movq -72(%rbp), %r13		# movq -72(%rbp), %r(243)
	addq %r15, %r13		# addq %r(208), %r(243)
	movq %r13, -72(%rbp)		# movq %r(243), -72(%rbp)
	movq -72(%rbp), %rbx		# movq -72(%rbp), %r(244)
	movq (%rbx), %rbx		# movq (%r(244)), %r(210)
	movq %rbx, (%r14)		# movq %r(210), (%r(206))
	movq -24(%rbp), %rbx		# movq -24(%rbp), %r(245)
	incq %rbx		# incq %r(245)
	movq %rbx, -24(%rbp)		# movq %r(245), -24(%rbp)
	jmp .L50		# jmp .L50
	.L52:		# .L52:
	movq -8(%rbp), %rbx		# movq -8(%rbp), %r(246)
	movq %rbx, %rax		# movq %r(246), %rax
	jmp .L53		# jmp .L53
	.L53:		# .L53:
	popq %r15
	popq %r14
