...
_Imain_paai:
	...
	movq %rax, %r12		# movq %rax, %r(4675)
	movq %r12, %r14		# movq %r(4675), %r(4673)
	movq $10, %rbx		# movq $10, %r(4738)
	movq %rbx, %r13		# movq %r(4738), %r(4674)
	movq %r12, %rdi		# movq %r(4675), %rdi
...
_I_c_internal_strdup_aii:
	...
	movq %r12, -8(%rbp)		# movq %r(4754), -8(%rbp)
	movq -8(%rbp), %r12		# movq -8(%rbp), %r(4755)
	...
	movq -8(%rbp), %rbx		# movq -8(%rbp), %r(4757)
	movq %rbx, %r12		# movq %r(4757), %r(4746)
	salq $3, %r12		# salq $3, %r(4746)
	movq -16(%rbp), %rbx		# movq -16(%rbp), %r(4758)
	movq %rbx, %r14		# movq %r(4758), %r(4759)
	movq %r14, -24(%rbp)		# movq %r(4759), -24(%rbp)
	movq -24(%rbp), %rbx		# movq -24(%rbp), %r(4760)
	addq %r12, %rbx		# addq %r(4746), %r(4760)
	movq %rbx, -24(%rbp)		# movq %r(4760), -24(%rbp)
	movq -24(%rbp), %rbx		# movq -24(%rbp), %r(4761)
	movq (%rbx), %r12		# movq (%r(4761)), %r(4748)
	movq %r12, (%r13)		# movq %r(4748), (%r(4745))
	movq -8(%rbp), %rbx		# movq -8(%rbp), %r(4762)
	decq %rbx		# decq %r(4762)
	movq %rbx, -8(%rbp)		# movq %r(4762), -8(%rbp)
	movq $0, %rbx		# movq $0, %r(4749)
	movq -8(%rbp), %r12		# movq -8(%rbp), %r(4763)
