...
_I_c_internal_strdup_aii:
	...
	movq %rbx, -8(%rbp)		# movq %r(209), -8(%rbp)
	movq -8(%rbp), %rbx		# movq -8(%rbp), %r(210)
	movq (%rbx), %rbx		# movq (%r(210)), %r(197)
	movq %rbx, %r14		# movq %r(197), %r(t10)
	movq %r14, %rbx		# movq %r(t10), %r(198)
	...
	jmp .L14		# jmp .L14
	.L14:		# .L14:
	movq %r14, %rbx		# movq %r(t10), %r(201)
	salq $3, %rbx		# salq $3, %r(201)
	movq %r13, %r15		# movq %r(170), %r(202)
	addq %rbx, %r15		# addq %r(201), %r(202)
	movq %r14, %r12		# movq %r(t10), %r(203)
	salq $3, %r12		# salq $3, %r(203)
	movq -8(%rbp), %rbx		# movq -8(%rbp), %r(211)
	movq %rbx, -16(%rbp)		# movq %r(212), -16(%rbp)
	movq -16(%rbp), %rbx		# movq -16(%rbp), %r(213)
	addq %r12, %rbx		# addq %r(203), %r(213)
	movq %rbx, -16(%rbp)		# movq %r(213), -16(%rbp)
	movq -16(%rbp), %rbx		# movq -16(%rbp), %r(214)
	movq (%rbx), %rbx		# movq (%r(214)), %r(205)
	movq %rbx, (%r15)		# movq %r(205), (%r(202))
	decq %r14		# decq %r(t10)
	movq $0, %rbx		# movq $0, %r(206)
	cmpq %rbx, %r14		# cmpq %r(206), %r(t10)
	jge .L14		# jge .L14
	.L15:		# .L15:
	movq $8, %rbx		# movq $8, %r(207)
	movq %r13, %r12		# movq %r(170), %r(208)
