...
_I_c_dynamalloc_aiai:
	...
	movq %rbx, -48(%rbp)		# movq %r(3762), -48(%rbp)
	movq $8, %rbx		# movq $8, %r(3719)
	movq -48(%rbp), %r14		# movq -48(%rbp), %r(3763)
	...
	movq %rbx, -24(%rbp)		# movq %r(3764), -24(%rbp)
	movq $1, %r13		# movq $1, %r(3722)
	movq %r13, %rbx		# movq %r(3722), %r(3765)
	movq %rbx, -56(%rbp)		# movq %r(3765), -56(%rbp)
	movq $0, %rbx		# movq $0, %r(3723)
	movq -24(%rbp), %r12		# movq -24(%rbp), %r(3766)
	...
	movq -48(%rbp), %r13		# movq -48(%rbp), %r(3784)
	movq %r13, %rbx		# movq %r(3784), %r(3785)
	movq %rbx, -96(%rbp)		# movq %r(3785), -96(%rbp)
	movq -96(%rbp), %rbx		# movq -96(%rbp), %r(3786)
	movq -104(%rbp), %r12		# movq -104(%rbp), %r(3816)
	addq %r12, %rbx		# addq %r(3816), %r(3786)
	movq %rbx, -96(%rbp)		# movq %r(3786), -96(%rbp)
	movq -96(%rbp), %rbx		# movq -96(%rbp), %r(3787)
	movq (%rbx), %r12		# movq (%r(3787)), %r(3742)
	movq %r12, (%r15)		# movq %r(3742), (%r(3739))
	movq -56(%rbp), %rbx		# movq -56(%rbp), %r(3788)
	incq %rbx		# incq %r(3788)
	movq %rbx, -56(%rbp)		# movq %r(3788), -56(%rbp)
	jmp .L321		# jmp .L321
	.L322:		# .L322:
	movq $0, %r13		# movq $0, %r(3743)
	movq $8, %rbx		# movq $8, %r(3744)
	movq -48(%rbp), %r12		# movq -48(%rbp), %r(3789)
	...
	movq -48(%rbp), %r12		# movq -48(%rbp), %r(3790)
	...
	movq %rbx, -56(%rbp)		# movq %r(3791), -56(%rbp)
	movq $1, %rbx		# movq $1, %r(3751)
	movq -56(%rbp), %r14		# movq -56(%rbp), %r(3792)
	...
	movq -56(%rbp), %rbx		# movq -56(%rbp), %r(3793)
	...
	movq %rbx, -32(%rbp)		# movq %r(3797), -32(%rbp)
	jmp .L327		# jmp .L327
	.L327:		# .L327:
	movq $0, %rbx		# movq $0, %r(3756)
	movq -56(%rbp), %r12		# movq -56(%rbp), %r(3798)
	cmpq %rbx, %r12		# cmpq %r(3756), %r(3798)
	jle .L328		# jle .L328
	.L329:		# .L329:
	movq -56(%rbp), %rbx		# movq -56(%rbp), %r(3799)
	decq %rbx		# decq %r(3799)
	movq %rbx, -56(%rbp)		# movq %r(3799), -56(%rbp)
	movq -40(%rbp), %rbx		# movq -40(%rbp), %r(3800)
	movq %rbx, %rdi		# movq %r(3800), %rdi
	call _I_c_dynamalloc_aiai		# call _I_c_dynamalloc_aiai
	movq %rax, %rbx		# movq %rax, %r(3801)
	movq %rbx, -8(%rbp)		# movq %r(3801), -8(%rbp)
	movq $8, %r13		# movq $8, %r(3757)
	movq -32(%rbp), %r14		# movq -32(%rbp), %r(3802)
	movq %r14, %rbx		# movq %r(3802), %r(3803)
	movq %rbx, -80(%rbp)		# movq %r(3803), -80(%rbp)
	movq -80(%rbp), %rbx		# movq -80(%rbp), %r(3804)
	subq %r13, %rbx		# subq %r(3757), %r(3804)
	movq %rbx, -80(%rbp)		# movq %r(3804), -80(%rbp)
	movq -80(%rbp), %rbx		# movq -80(%rbp), %r(3805)
	movq (%rbx), %r12		# movq (%r(3805)), %r(3759)
	movq -56(%rbp), %rbx		# movq -56(%rbp), %r(3806)
	cmpq %r12, %rbx		# cmpq %r(3759), %r(3806)
	jae error_outofbounds		# jae error_outofbounds
	movq -56(%rbp), %r12		# movq -56(%rbp), %r(3807)
	movq %r12, %r14		# movq %r(3807), %r(3760)
	salq $3, %r14		# salq $3, %r(3760)
	movq -32(%rbp), %r13		# movq -32(%rbp), %r(3808)
	movq %r13, %rbx		# movq %r(3808), %r(3809)
	movq %rbx, -16(%rbp)		# movq %r(3809), -16(%rbp)
	movq -16(%rbp), %rbx		# movq -16(%rbp), %r(3810)
	addq %r14, %rbx		# addq %r(3760), %r(3810)
	movq %rbx, -16(%rbp)		# movq %r(3810), -16(%rbp)
	movq -16(%rbp), %rbx		# movq -16(%rbp), %r(3811)
	movq -8(%rbp), %r12		# movq -8(%rbp), %r(3812)
	movq %r12, (%rbx)		# movq %r(3812), (%r(3811))
	jmp .L327		# jmp .L327
	.L328:		# .L328:
	movq -32(%rbp), %rbx		# movq -32(%rbp), %r(3813)
