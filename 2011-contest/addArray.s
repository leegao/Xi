...
_I_c_internal_strdup_aii:
	...
	movq -24(%rbp), %rbx		# movq -24(%rbp), %r(96)
...
_I_c_internal_strcat_aiaiai:
	...
	movq %rbx, -64(%rbp)		# movq %r(125), -64(%rbp)
	movq %rsi, %rbx		# movq %rsi, %r(126)
	movq %rbx, -56(%rbp)		# movq %r(126), -56(%rbp)
	movq $0, %r12		# movq $0, %r(102)
	movq %r12, -16(%rbp)		# movq %r(127), -16(%rbp)
	movq $8, %rbx		# movq $8, %r(103)
	movq -64(%rbp), %r13		# movq -64(%rbp), %r(128)
	subq %rbx, %r13		# subq %r(103), %r(104)
	movq (%r13), %r12		# movq (%r(104)), %r(105)
	movq %r12, -24(%rbp)		# movq %r(129), -24(%rbp)
	movq $8, %rbx		# movq $8, %r(106)
	movq -56(%rbp), %r13		# movq -56(%rbp), %r(130)
	subq %rbx, %r13		# subq %r(106), %r(107)
	movq (%r13), %rbx		# movq (%r(107)), %r(108)
	movq -24(%rbp), %r12		# movq -24(%rbp), %r(131)
	addq %rbx, %r12		# addq %r(108), %r(109)
	movq %r12, -40(%rbp)		# movq %r(132), -40(%rbp)
	movq $1, %rbx		# movq $1, %r(110)
	movq -40(%rbp), %r13		# movq -40(%rbp), %r(133)
	addq %rbx, %r13		# addq %r(110), %r(111)
	movq %r13, %rdi		# movq %r(111), %rdi
	call _I_alloc_i		# call _I_alloc_i
	movq %rax, %rbx		# movq %rax, %r(37)
	movq -40(%rbp), %r12		# movq -40(%rbp), %r(134)
	movq %r12, (%rbx)		# movq %r(134), (%r(37))
	movq $8, %r12		# movq $8, %r(112)
	addq %r12, %rbx		# addq %r(112), %r(113)
	movq %rbx, -48(%rbp)		# movq %r(135), -48(%rbp)
	.L17:		# .L17:
	movq -16(%rbp), %rbx		# movq -16(%rbp), %r(136)
	movq -24(%rbp), %r12		# movq -24(%rbp), %r(137)
	cmpq %r12, %rbx		# cmpq %r(137), %r(136)
	jge .L19		# jge .L19
	.L18:		# .L18:
	movq -16(%rbp), %r13		# movq -16(%rbp), %r(138)
	salq $3, %r13		# salq $3, %r(114)
	movq -48(%rbp), %rbx		# movq -48(%rbp), %r(139)
	movq %rbx, -32(%rbp)		# movq %r(140), -32(%rbp)
	movq -32(%rbp), %r12		# movq -32(%rbp), %r(141)
	addq %r13, %r12		# addq %r(114), %r(141)
	movq %r12, -32(%rbp)		# movq %r(141), -32(%rbp)
	movq -16(%rbp), %r13		# movq -16(%rbp), %r(142)
	salq $3, %r13		# salq $3, %r(116)
	movq -64(%rbp), %rbx		# movq -64(%rbp), %r(143)
	movq %rbx, -8(%rbp)		# movq %r(144), -8(%rbp)
	movq -8(%rbp), %r12		# movq -8(%rbp), %r(145)
	addq %r13, %r12		# addq %r(116), %r(145)
	movq %r12, -8(%rbp)		# movq %r(145), -8(%rbp)
	movq -8(%rbp), %rbx		# movq -8(%rbp), %r(146)
	movq (%rbx), %rbx		# movq (%r(146)), %r(118)
	movq -32(%rbp), %r12		# movq -32(%rbp), %r(147)
	movq %rbx, (%r12)		# movq %r(118), (%r(147))
	movq -16(%rbp), %rbx		# movq -16(%rbp), %r(148)
	incq %rbx		# incq %r(148)
	movq %rbx, -16(%rbp)		# movq %r(148), -16(%rbp)
	jmp .L17		# jmp .L17
	.L19:		# .L19:
	.L20:		# .L20:
	movq -16(%rbp), %rbx		# movq -16(%rbp), %r(149)
	movq -40(%rbp), %r12		# movq -40(%rbp), %r(150)
	cmpq %r12, %rbx		# cmpq %r(150), %r(149)
	jge .L22		# jge .L22
	.L21:		# .L21:
	movq -16(%rbp), %r13		# movq -16(%rbp), %r(151)
	salq $3, %r13		# salq $3, %r(119)
	movq -48(%rbp), %r14		# movq -48(%rbp), %r(152)
	addq %r13, %r14		# addq %r(119), %r(120)
	movq -16(%rbp), %rbx		# movq -16(%rbp), %r(153)
	movq -24(%rbp), %r13		# movq -24(%rbp), %r(154)
	subq %r13, %rbx		# subq %r(154), %r(121)
	salq $3, %rbx		# salq $3, %r(122)
	movq -56(%rbp), %r12		# movq -56(%rbp), %r(155)
	addq %rbx, %r12		# addq %r(122), %r(123)
	movq (%r12), %rbx		# movq (%r(123)), %r(124)
	movq %rbx, (%r14)		# movq %r(124), (%r(120))
	movq -16(%rbp), %rbx		# movq -16(%rbp), %r(156)
	incq %rbx		# incq %r(156)
	movq %rbx, -16(%rbp)		# movq %r(156), -16(%rbp)
	jmp .L20		# jmp .L20
	.L22:		# .L22:
	movq -48(%rbp), %rbx		# movq -48(%rbp), %r(157)
	movq %rbx, %rax		# movq %r(157), %rax
	.L23:		# .L23:
	popq %r15
	popq %r14
	popq %r13
