...
_I_c_internal_strcat_aiaiai:
	...
	jge .L51		# jge .L51
	.L50:		# .L50:
	movq -8(%rbp), %r13		# movq -8(%rbp), %r(237)
	salq $3, %r13		# salq $3, %r(205)
	movq -56(%rbp), %r14		# movq -56(%rbp), %r(238)
	addq %r13, %r14		# addq %r(205), %r(206)
	movq -8(%rbp), %rbx		# movq -8(%rbp), %r(239)
	movq -16(%rbp), %r13		# movq -16(%rbp), %r(240)
	subq %r13, %rbx		# subq %r(240), %r(207)
	salq $3, %rbx		# salq $3, %r(208)
	movq -40(%rbp), %r12		# movq -40(%rbp), %r(241)
	addq %rbx, %r12		# addq %r(208), %r(209)
	movq (%r12), %rbx		# movq (%r(209)), %r(210)
	movq %rbx, (%r14)		# movq %r(210), (%r(206))
	movq -8(%rbp), %rbx		# movq -8(%rbp), %r(242)
	incq %rbx		# incq %r(242)
	movq %rbx, -8(%rbp)		# movq %r(242), -8(%rbp)
	jmp .L49		# jmp .L49
	.L51:		# .L51:
	movq -56(%rbp), %rbx		# movq -56(%rbp), %r(243)
