...
_Imain_paai:
	...
	movq -8(%rbp), %r13		# movq -8(%rbp), %r(96)
	addq %rbx, %r13		# addq %r(82), %r(83)
	movq (%r13), %rbx		# movq (%r(83)), %r(84)
	movq %rbx, %rdi		# movq %r(84), %rdi
	call _Iprintln_pai		# call _Iprintln_pai
	movq -24(%rbp), %rbx		# movq -24(%rbp), %r(97)
	incq %rbx		# incq %r(97)
	movq %rbx, -24(%rbp)		# movq %r(97), -24(%rbp)
	jmp .L33		# jmp .L33
	.L35:		# .L35:
	.L32:		# .L32:
	popq %r15
