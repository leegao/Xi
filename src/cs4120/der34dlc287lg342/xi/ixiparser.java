...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Fri Sep 30 00:29:23 EDT 2011
  */
  ...
  public final java_cup.runtime.Symbol CUP$ixiparser$do_action(
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$ixiparser$act_num)
		...
		ArrayList<Integer> dim = (ArrayList<Integer>)((java_cup.runtime.Symbol) CUP$ixiparser$stack.peek()).value;
			RESULT = arr;
		...
		int arrleft = ((java_cup.runtime.Symbol)CUP$ixiparser$stack.elementAt(CUP$ixiparser$top-3)).left;
		int arrright = ((java_cup.runtime.Symbol)CUP$ixiparser$stack.elementAt(CUP$ixiparser$top-3)).right;
		ArrayList<Integer> arr = (ArrayList<Integer>)((java_cup.runtime.Symbol) CUP$ixiparser$stack.elementAt(CUP$ixiparser$top-3)).value;
		...
		Token t = (Token)((java_cup.runtime.Symbol) CUP$ixiparser$stack.elementAt(CUP$ixiparser$top-1)).value;
		...
		ArrayList<Integer> arr = (ArrayList<Integer>)((java_cup.runtime.Symbol) CUP$ixiparser$stack.peek()).value;
